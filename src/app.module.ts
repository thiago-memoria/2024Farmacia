...
@Module({
  imports: [CartModule, ProductModule, ShoppingModule, UsersModule, AddressModule,
    WalletsModule, CardsModule, AuthModule, CategoryModule,
    TypeOrmModule.forRoot({
      ...
      database: "Ifarma",
      entities: [CartEntity, UserEntity, ShoppingEntity, ProductEntity, CategoryEntity, AddressEntity, CardEntity, WalletEntity],
